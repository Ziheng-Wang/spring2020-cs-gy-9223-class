...
class SimulatorView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.POST.get("created_at_wds"):
            post_created_at = request.POST.get("created_at_wds")
            post_current_wind_speed = request.POST.get("current_wind_speed")

            wds_data = WindSpeedSensor(
    ...
    def get(self, request, *args, **kwargs):
        ...
        form_wds = WindSpeedForm(initial=initial_data)
        context = {
            "form_temp": form_temp,
